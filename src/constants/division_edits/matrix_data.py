...
DIVISION_MATRICES = {
    ...
    "MatrixCostName_US_3rd_Arm_multi": (
        ...
        '    (EDefaultFactories/Planes, [2, 2, 4, 4, 5, 8]),'
        '    (EDefaultFactories/Recons, [2, 2, 2, 3, 3, 3, 4]),'
    ...
    "MatrixCostName_SOV_119IndTkBrig_multi": (                           
        ...
        '    (EDefaultFactories/Recons, [2, 2, 2, 3, 3, 3, 3, 3]),'
    ...
    "MatrixCostName_SOV_27_Gds_Rifle_multi": (
        ...
        '    (EDefaultFactories/DCA, [2, 2, 2, 4, 4, 4]),'
        '    (EDefaultFactories/Defense, []),'
        '    (EDefaultFactories/Helis, [2, 4, 4]),'
        '    (EDefaultFactories/Infantry, [2, 2, 2, 2, 3, 3, 3, 4, 5]),'
