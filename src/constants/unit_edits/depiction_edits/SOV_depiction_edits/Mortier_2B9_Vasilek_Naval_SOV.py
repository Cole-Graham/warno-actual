...
# fmt: off
mortier_2b9_vasilek_naval_sov: Dict[str, Dict[Union[str, Tuple[str, str]], dict]] = {
    "unit_name": "Mortier_2B9_Vasilek_Naval_SOV",
    "valid_files": ["DepictionVehicles.ndf"],
    "DepictionVehicles_ndf": {
        "new_objects": {
            "weapon3": """
                DepictionOperator_Mortier_2B9_Vasilek_Naval_SOV_Weapon3 is DepictionOperator_WeaponInstantFire
                (
        ...
        (None, "TacticVehicleDepictionRegistration"): {
            "Operators": {
                7: ("add", (
                    "DepictionOperator_Mortier_2B9_Vasilek_Naval_SOV_Weapon3"
                )),
            },
            "Actions": (
                'MAP['
