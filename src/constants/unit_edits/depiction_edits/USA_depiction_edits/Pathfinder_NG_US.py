"""Pathfinder_NG_US depiction edits."""

from typing import Dict, Tuple, Union

# fmt: off
pathfinder_ng_us: Dict[str, Dict[Union[str, Tuple[str, str]], dict]] = {
    "unit_name": "Pathfinder_NG_US",
    ...
    "DepictionInfantry_ndf": {
        ...
        ("AllWeaponSubDepiction_Pathfinder_NG_US", "TemplateAllSubWeaponDepiction"): {
            "Operators": {
        ...
        ("TacticDepiction_Pathfinder_NG_US_Soldier", "TemplateInfantryDepictionFactoryTactic"): {
