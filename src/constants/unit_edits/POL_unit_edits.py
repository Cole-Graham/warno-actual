...
pol_unit_edits = {
    ...
    "Descriptor_Unit_DCA_ZU_23_2_Para_POL": {  # Desant. ZU-23-2
        "CommandPoints": 20,
        "Factory": "EDefaultFactories/Logistic",
        "Divisions": {
            "default": {
    ...
    "Descriptor_Unit_DCA_ZUR_23_2S_JOD_Para_POL": {  # Desant. ZUR-23-2S Jod
        "CommandPoints": 30,
        "Factory": "EDefaultFactories/Logistic",
        # "Divisions": {
        #     "default": {
    ...
    "Descriptor_Unit_UAZ_469_CMD_Para_POL": {  # Desant. WD-43
        "GameName": {
    ...
    "Descriptor_Unit_UAZ_469_supply_Para_POL": {  # Desant. UAZ-469 Zaop.
        "GameName": {
            "display": "SPADO. GAZ-66B ZAOP.",
        },
    },
    ...
    "Descriptor_Unit_Groupe_AT_Para_POL": {  # Desant. Druzyna Ppanc.
        "GameName": {
    ...
    "Descriptor_Unit_Para_Security_POL": {  # Desant. Ochrona
        "GameName": {
            "display": "SPADO. OCHRONA",
        },
    },

    "Descriptor_Unit_Reserve_CMD_POL": {
        "GameName": {
            "display": "#CMD REZERWIŚCI DOW."
        }
    },

    "Descriptor_Unit_Reserve_POL": {
        "GameName": {
            "display": "REZERWIŚCI"
        }
    },
    ...
    "Descriptor_Unit_Mortier_2S12_120mm_Para_POL": {  # Desant. 2S12 120mm
        # "CommandPoints": 40,
        # "availability": 5,
        # "XPMultiplier": [5/5, 4/5, 3/5, 0.0],
        "GameName": {
    ...
    "Descriptor_Unit_Mortier_M43_82mm_Para_POL": {  # Desant. M43 82mm
        "GameName": {
            "display": "SPADO. M wz. 43 82mm",
        },
    },

    "Descriptor_Unit_Mortier_M43_82mm_POL": {  # Desant. M43 82mm
        "GameName": {
    ...
    "Descriptor_Unit_MLRS_WP_8z_POL": {  # Desant. M43 82mm
        "GameName": {
            "display": "WP-8z 140mm",
        },
    },
    ...
    "Descriptor_Unit_Sniper_paras_POL": {  # Desant. Snajper
        "GameName": {
    ...
    "Descriptor_Unit_Osa_9K33M3_POL": {  # PWRB Osa-AKM
        "optics": {
    ...
    "Descriptor_Unit_W3W_Sokol_RKT_POL": {  # W-3 Sokol [RKT
        "GameName": {
            "display": "W-3 SOKÓŁ [RKT]"
        }
    },

    "Descriptor_Unit_W3W_Sokol_AA_POL": {  # W-3 Sokol [AA]
        "GameName": {
