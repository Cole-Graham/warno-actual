...
weapons: Dict[WeaponKey, WeaponData] = {
    ...
    ("DCA_4_canon_Maxson_towed_12_7mm", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
    ...
    ("DCA_4_canon_Maxson_SP_12_7mm", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
                "MaximumRangeGRU": 1400,
                "MaximumRangeHelicopterGRU": 1925,
    ...
    ("DCA_1_canon_FK20_20mm_TOWED", "DCA", None, False): {
        "Ammunition": {
            "hit_roll": {
                "Idling": 15,
            },
    ...
    ("DCA_1_canon_FK20_20mm", "DCA", None, False): {
        "Ammunition": {
            "hit_roll": {
                "Idling": 15,
            },
     ...
     ("DCA_2_canon_FK20_20mm", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
                "MaximumRangeGRU": 1575,
                "AimingTime": 1.2,
    ...
    ("DCA_1_canon_53T2_20mm_TOWED", "DCA", None, False): {
        "Ammunition": {
            "hit_roll": {
                "Idling": 15,
            },
    ...
    ("DCA_2_canon_76T2_20mm", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
                "MaximumRangeGRU": 1575,
                "AimingTime": 1.2,
    ...
    ("DCA_2_canons_HS_831_30mm_TOWED", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
                "MaximumRangeHelicopterGRU": 2625,
    ...
    ("DCA_1_canon_Bofors_40mm_L60", "DCA", None, False): {
        "Ammunition": {
            "parent_membr": {
                "TimeBetweenTwoShots": 0.3,
                "TimeBetweenTwoFx": 0.3,
