...
AMMUNITION_RENAMES = [
    ...
    ("RocketAir_B8_80mm_x10_Avion", "RocketAir_B8_80mm_avion_salvolength10"),
...
AMMUNITION_MISSILES_RENAMES = [
    ...
    ("ATGM_BGM71C_ITOW_x2_IFV", "ATGM_BGM71C_ITOW_IFV_salvolength2"),
    ("ATGM_BGM71D_TOW_2_x2_IFV", "ATGM_BGM71D_TOW_2_IFV_salvolength2"),
