...
# fmt: off
hmgteam_ags17_para_pol: Dict[str, Dict[str, Any]] = {
    "unit_name": "HMGteam_AGS17_para_POL",
    ...
    "DepictionVehicles_ndf": {
        ...
        "DepictionOperator_WeaponInstantFire": (
            f'DepictionOperator_HMGteam_AGS17_para_POL_Weapon1 is DepictionOperator_WeaponInstantFire'
            f'('
        ...
        "TacticVehicleDepictionRegistration": (
            ...
            f'          DepictionOperator_HMGteam_AGS17_para_POL_Weapon1,'
            ...
            f'      SubDepictions = ['
            f'      ] + HumanSubDepictions_HMGteam_AGS17_para_POL'
            f'  )'
        ),
    },
}
