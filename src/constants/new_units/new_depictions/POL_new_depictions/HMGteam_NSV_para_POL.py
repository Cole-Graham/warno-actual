...
hmgteam_nsv_para_pol: Dict[str, Dict[str, Any]] = {
    "unit_name": "HMGteam_NSV_para_POL",
    ...
    "DepictionVehicles_ndf": {       
        "DepictionOperator_WeaponContinuousFire": (
            f'DepictionOperator_HMGteam_NSV_para_POL_Weapon1 is DepictionOperator_WeaponContinuousFire'
            f'('
        ...
        "TacticVehicleDepictionRegistration": (
            ...
            f'    ('
            f'        BlackHoleKey = "HMGteam_NSV_para_POL"'
            f'        Selector = SpecificMechanicalDepictionSelector'
            f'        Alternatives = Alternatives_HMGteam_NSV_para_POL'
            f'        Operators = '
            f'        ['
            ...
            f'            DepictionOperator_HMGteam_NSV_para_POL_Weapon1,'
            ...
            f'        SubDepictions = ['
            f'        ] + HumanSubDepictions_HMGteam_NSV_para_POL'
            f'    )'
        ),
    },
}
