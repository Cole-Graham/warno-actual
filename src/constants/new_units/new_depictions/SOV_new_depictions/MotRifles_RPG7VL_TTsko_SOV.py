"""MotRifles_RPG7VL_TTsko_SOV depiction edits."""

from typing import Dict, Tuple, Union

# fmt: off
motrifles_rpg7vl_ttsko_sov: Dict[str, Dict[Union[str, Tuple[str, str]], dict]] = {
    "unit_name": "MotRifles_RPG7VL_TTsko_SOV",
    "valid_files": ["DepictionInfantry.ndf"],
    "DepictionInfantry_ndf": {
        ("AllWeaponAlternatives_MotRifles_RPG7VL_TTsko_SOV", None): ( # (namespace, object type)
