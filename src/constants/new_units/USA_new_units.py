...
USA_NEW_UNITS = {
    ...
    ("M1038_Humvee_US", 0): {
        ...
        "orders": ['EOrderType/Stop', 'EOrderType/Move', 'EOrderType/FollowFormation', 'EOrderType/FollowUnit', 'EOrderType/QuickMove', 'EOrderType/Reverse',
                   'EOrderType/SupplyUnit', 'EOrderType/AskForSupply', 'EOrderType/AIStop', 'EOrderType/AISupply'],
    ...
    #     "InfantrySquadModuleGUID": "4e620fd4-7d88-4cee-9a21-c3f0f03203cd",
    ...
    #                'EOrderType/Reverse', 'EOrderType/Shoot', 'EOrderType/ShootOnPosition', 'EOrderType/ShootOnPositionWithoutCorrection', 'EOrderType/ShootDefensiveSmoke',
    #                'EOrderType/AskForSupply', 'UnloadFromTransport', 'UnloadAtPosition', 'LoadUnit', 'EOrderType/AIDefend', 'EOrderType/AIAttack', 'EOrderType/AIStop'],
    #     "is_infantry": False, # False for Javelin LML (unique exception), towed units.
    #     "is_heavy_equipment": False,
    #     "is_ground_vehicle": True,
    #     "is_aerial": False,
    ...
    #     "InfantrySquadModuleGUID": "f98fafe9-6cbb-409d-b056-645469c252e3",
