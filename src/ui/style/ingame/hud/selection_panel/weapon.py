...
def edit_uispecificunitselectionweaponpanelview(source_path) -> None:
    ...
    Args:
        source: NDF file containing HUD unit selection weapon panel view definitions
    """
...
def _update_weapon_status_elements(elements: Any) -> None:
    ...
    for element in elements:
        ...
        if component_descr.type == "BUCKChronoAnimatedTextureDescriptor":
            component_descr.by_member("ChronoForegroundColor").v = '"M81_AppleIIc"' 