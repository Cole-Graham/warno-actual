from .ammunition_ import (
    edit_gen_gp_gfx_ammunition,
    edit_gen_gp_gfx_ammunitionmissiles,
    edit_gen_gp_gfx_missiledescriptors,
)
from .buildingdescriptors import edit_gen_gp_gfx_buildingdescriptors
from .capacitelist import edit_gen_gp_gfx_capacitelist
from .conditionsdescriptor import edit_gen_gp_gfx_conditionsdescriptor
from .damagelevels import edit_gen_gp_gfx_damagelevels
from .damageresistance import (
...
from .weapon_descriptor import edit_gen_gp_gfx_weapondescriptor
