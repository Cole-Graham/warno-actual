...
def edit_template_critical(source) -> None:
...
def edit_airplane_critical(source) -> None:
...
def edit_groundunit_critical(source) -> None:
    """ ______________________________PLACEHOLDER_______________________________
...
def edit_helico_critical(source) -> None:
    """ ______________________________PLACEHOLDER_______________________________
...
def edit_infanterie_critical(source) -> None:
    """ ______________________________PLACEHOLDER_______________________________
...
def edit_testunits_critical(source) -> None:
    """ ______________________________PLACEHOLDER_______________________________
