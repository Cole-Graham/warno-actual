...
def find_obj_by_blackhole_key(ndf_list: ndf.model.List, blackhole_key: str, obj_type: str) -> Any:
    """Find an object by its BlackHoleKey member value.
    ...
    return ndf_list.find_by_cond(match_blackhole_key, strict=False)
